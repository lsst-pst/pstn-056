...
%\newwatermark*[allpages]{DRAFT}%,angle=45,xpos=-10000,ypos=-100]%{draft}%,scale=3,xpos=-100,ypos=0]


%\usepackage{background}
%\SetupBackground[contents={\color{red!75} "DRAFT"}]{backgroundsetup={opacity=0.75}}
