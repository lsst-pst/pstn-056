...
\begin{figure}
\centering
    %\includegraphics[width=0.75\textwidth]{figures/baseline_v3_0_10yrs_nvisits_galactic.pdf}
    %\includegraphics[width=0.75\textwidth]{figures/baseline_v3_6_10yrs_nvisits_galactic.pdf}
    \includegraphics[width=0.3\linewidth]{figures/RollingUniform.png}
