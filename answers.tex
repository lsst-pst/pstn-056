...
\begin{figure}
\centering
    \includegraphics[width=0.75\textwidth]{figures/baseline_v3.0_10yrs_nvisits_galactic_0.png}
    \includegraphics[width=0.75\textwidth]{figures/baseline_v3.6_10yrs_nvisits_galactic_0.png}
    %\includegraphics[width=0.3\linewidth]{figures/RollingUniform.png}
